    ...
    <>
      ...
      <section className="container-shell grid gap-10 py-24 lg:grid-cols-[1fr_0.95fr] lg:items-center">
        <div>
          ...
          <div className="mt-10 max-w-4xl rounded-[2rem] border border-slate-200 bg-white p-8 text-base leading-8 text-slate-700 shadow-[0_12px_36px_rgba(23,49,58,0.05)]">
            <p>{location.intro}</p>
            <p className="mt-6 font-semibold text-accent">{location.responseTime}</p>
          </div>
        </div>
        <div className="soft-panel overflow-hidden">
          <img src="/images/biohazard-cleaning-mackay-on-site-team.jpg" alt="On-site biohazard cleaning in Mackay region" className="h-full min-h-[340px] w-full object-cover" />
        </div>
      </section>
