  ...
  return (
    <>
      ...
      <section className="container-shell grid gap-10 py-24 lg:grid-cols-[1fr_0.95fr] lg:items-start">
        <div>
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.22em] text-accent">24/7 Urgent Response Line</p>
        ...
        <div className="space-y-8">
          <div className="soft-panel overflow-hidden">
            <Image src="/images/biohazard-cleaning-mackay-on-site-team.jpg" alt="On-site biohazard cleaning in Mackay" width={1200} height={900} className="h-full min-h-[320px] w-full object-cover" />
          </div>
          <form action={siteConfig.formEndpoint} method="POST" className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_18px_48px_rgba(23,49,58,0.08)]">
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <select name="service" className="rounded-2xl border border-slate-300 bg-white px-4 py-3 text-slate-900 outline-none sm:col-span-2">
                ...
                <option>Hoarding & Squalor Recovery</option>
                <option>Decluttering & Property Reset</option>
